    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_flag)
            ...
            private fun obyektYaratish() {
                ...
                flagArrayList.add(Flag("brazil", R.drawable.braziliya))
                flagArrayList.add(Flag("armenia", R.drawable.armaniston))
                flagArrayList.add(Flag("portugal", R.drawable.portugaliya))
            }
